...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.Deploy.Intercept(interceptors...)
	c.EnvVar.Intercept(interceptors...)
...
type (
	hooks struct {
		App, Container, Deploy, EnvVar, Site []ent.Hook
	}
	inters struct {
		App, Container, Deploy, EnvVar, Site []ent.Interceptor
	}
)
