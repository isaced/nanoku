...
type ContainerFunc func(context.Context, *db.ContainerMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f ContainerFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.ContainerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *db.ContainerMutation", m)
}

// The DeployFunc type is an adapter to allow the use of ordinary
// function as Deploy mutator.
type DeployFunc func(context.Context, *db.DeployMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f DeployFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.DeployMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *db.DeployMutation", m)
}

// The EnvVarFunc type is an adapter to allow the use of ordinary
// function as EnvVar mutator.
type EnvVarFunc func(context.Context, *db.EnvVarMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f EnvVarFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.EnvVarMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f SiteFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.SiteMutation); ok {
		return f(ctx, mv)
	}
